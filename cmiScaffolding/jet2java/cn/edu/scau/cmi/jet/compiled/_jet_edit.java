...
public class _jet_edit implements JET2Template {
    ...
    private static final TagInfo _td_c_include_3_2 = new TagInfo("c:include", //$NON-NLS-1$
            3, 2,
            new String[] {
                "template", //$NON-NLS-1$
            },
    ...
    private static final TagInfo _td_c_include_4_2 = new TagInfo("c:include", //$NON-NLS-1$
            ...
            new String[] {
                "templates/content/jsp/fragment/edit/body.jet", //$NON-NLS-1$
            } );
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(NL);         
        RuntimeTagElement _jettag_c_include_3_2 = context.getTagFactory().createRuntimeTag(_jetns_c, "include", "c:include", _td_c_include_3_2); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_include_3_2.setRuntimeParent(null);
        _jettag_c_include_3_2.setTagInfo(_td_c_include_3_2);
        _jettag_c_include_3_2.doStart(context, out);
        _jettag_c_include_3_2.doEnd();
